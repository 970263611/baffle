 ...
 */
@Component
public class DeleteFileFormMethodTemplate extends AbstractFileFormMethodTemplate {

    public DeleteFileFormMethodTemplate(RequestTemplateFacade requestTemplateFacade) {
    ...
    Request forward(Request.Builder builder, String url, Map<String, String> headers, String body) {
        ...
        return builder.delete(multipartBody.build()).url(url).build();
    }
