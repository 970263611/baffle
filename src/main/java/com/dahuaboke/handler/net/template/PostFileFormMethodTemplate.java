 ...
 */
@Component
public class PostFileFormMethodTemplate extends AbstractFileFormMethodTemplate {

    public PostFileFormMethodTemplate(RequestTemplateFacade requestTemplateFacade) {
    ...
    Request forward(Request.Builder builder, String url, Map<String, String> headers, String body) {
        ...
        return builder.post(multipartBody.build()).url(url).build();
    }
